...
public class MCPHTTPEndpointTest
{
    ...
    @Test
    void toolsList_containsResolveGlobalSymbolTool() throws Exception
    {
        String body = postMcp("""
                        {
                          "jsonrpc": "2.0",
                        ...
                        """, sessionId);
        assertThat(body).contains("resolve_global_symbol");
    }
    ...
    @Test
    void toolCall_ResolveGlobalSymbol_returnsGreeting() throws Exception
    {
        String body = postMcp("""
                        {
                          "jsonrpc": "2.0",
